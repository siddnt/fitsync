        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSubmit(formData); }} className="profile-form">
          ...
          <section className="profile-form__section">
            ...
            <div className="profile-form__grid">
              <div className="form-field">
                ...
                <input type="text" id="firstName" name="firstName" value={formData.firstName} onChange={handleChange} className={errors.firstName ? 'error' : ''} autoComplete="given-name" />
              ...
              <div className="form-field">
                ...
                <input type="number" id="age" name="age" value={formData.age} onChange={handleChange} min="10" max="120" className={errors.age ? 'error' : ''} autoComplete="on" />
            ...
            <section className="profile-form__section">
              ...
              <div className="profile-form__grid">
                <div className="form-field">
                  ...
                  <input type="number" id="height" name="height" value={formData.height} onChange={handleChange} min="50" max="300" className={errors.height ? 'error' : ''} autoComplete="on" />
                  {errors.height && <span className="field-error">{errors.height}</span>}
                </div>
                <div className="form-field">
                  <label htmlFor="weight">Weight (kg)</label>
                  <input type="number" id="weight" name="weight" value={formData.weight} onChange={handleChange} min="20" max="500" className={errors.weight ? 'error' : ''} autoComplete="on" />
            ...
            <section className="profile-form__section">
              ...
              <div className="profile-form__grid">
                <div className="form-field">
                  ...
                  <input type="number" id="experienceYears" name="experienceYears" value={formData.experienceYears} onChange={handleChange} min="0" max="60" className={errors.experienceYears ? 'error' : ''} autoComplete="on" />
                ...
                <div className="form-field">
                  ...
                  <input type="number" id="mentoredCount" name="mentoredCount" value={formData.mentoredCount} onChange={handleChange} min="0" className={errors.mentoredCount ? 'error' : ''} autoComplete="on" />
                ...
                <div className="form-field form-field--full">
                  ...
                  <input type="text" id="specializations" name="specializations" value={formData.specializations} onChange={handleChange} placeholder="Strength training, Mobility, Nutrition" autoComplete="on" />
            ...
            <section className="profile-form__section">
              ...
              <div className="profile-form__grid">
                <div className="form-field form-field--full">
                  ...
                  <input type="text" id="profile.company" name="profile.company" value={formData['profile.company']} onChange={handleChange} placeholder="e.g., FitSync Fitness Pvt. Ltd." autoComplete="organization" />
                </div>
              </div>
            </section>
          )}
          ...
          <section className="profile-form__section">
            ...
            <div className="profile-form__grid">
              <div className="form-field">
                ...
                <input type="tel" id="contactNumber" name="contactNumber" value={formData.contactNumber} onChange={handleChange} className={errors.contactNumber ? 'error' : ''} autoComplete="tel" />
                {errors.contactNumber && <span className="field-error">{errors.contactNumber}</span>}
              </div>
              <div className="form-field form-field--full">
                <label htmlFor="address">Address</label>
                <input type="text" id="address" name="address" value={formData.address} onChange={handleChange} autoComplete="street-address" />
              </div>
              <div className="form-field form-field--full">
                <label htmlFor="profile.location">Location</label>
                <AutosuggestInput
                  value={formData['profile.location']}
                  onChange={(val) => setFormData((prev) => ({ ...prev, 'profile.location': val }))}
          ...
          <section className="profile-form__section">
            ...
            <div className="form-field">
              ...
              <input type="text" id="profile.headline" name="profile.headline" value={formData['profile.headline']} onChange={handleChange} placeholder="e.g., Fitness enthusiast | Marathon runner" maxLength="100" autoComplete="on" />
            </div>
            <div className="form-field">
          ...
          <section className="profile-form__section">
            ...
            <div className="profile-form__grid">
              <div className="form-field form-field--full">
                ...
                <input type="url" id="profile.socialLinks.website" name="profile.socialLinks.website" value={formData['profile.socialLinks.website']} onChange={handleChange} placeholder="https://your-website.com" autoComplete="url" />
              </div>
              <div className="form-field">
                <label htmlFor="profile.socialLinks.instagram">Instagram</label>
                <input type="text" id="profile.socialLinks.instagram" name="profile.socialLinks.instagram" value={formData['profile.socialLinks.instagram']} onChange={handleChange} placeholder="@username" autoComplete="on" />
              </div>
              <div className="form-field">
                <label htmlFor="profile.socialLinks.facebook">Facebook</label>
                <input type="text" id="profile.socialLinks.facebook" name="profile.socialLinks.facebook" value={formData['profile.socialLinks.facebook']} onChange={handleChange} placeholder="facebook.com/username" autoComplete="on" />
              </div>
            </div>
          </section>
